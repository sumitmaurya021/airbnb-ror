...
15.times do |i|
  ...
  property.images.attach(io: File.open("db/images/property_14.png"), filename: property.name)
  property.images.attach(io: File.open("db/images/property_15.png"), filename: property.name)
